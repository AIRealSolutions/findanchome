...
export default function LelandPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-purple-600 to-pink-400 text-white py-16">
        <div className="container mx-auto px-4">
          <Link href="/explore/brunswick" className="text-purple-100 hover:text-white mb-4 inline-flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to Brunswick County
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🏘️ {CITY_NAME}</h1>
          <p className="text-xl opacity-90">Growing Community with Modern Amenities & Family-Friendly Living</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Leland is a rapidly growing community in Brunswick County that combines small-town charm with modern conveniences. With excellent schools, growing business district, and family-oriented atmosphere, Leland attracts families and professionals seeking affordable homes in a thriving community.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-pink-50 p-6 rounded-lg">
            <div>
              ...
              <div className="text-gray-700 text-sm">Growing Population</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-pink-600">Family-Oriented</div>
              <div className="text-gray-700 text-sm">Community Focus</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Affordable</div>
              <div className="text-gray-700 text-sm">Home Values</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-pink-400 text-white">
