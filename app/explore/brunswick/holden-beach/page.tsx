...
export default function HoldenBeachPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-cyan-600 to-sky-400 text-white py-16">
        <div className="container mx-auto px-4">
          <Link href="/explore/brunswick" className="text-cyan-100 hover:text-white mb-4 inline-flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to Brunswick County
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🏝️ {CITY_NAME}</h1>
          <p className="text-xl opacity-90">Quiet Residential Beach Community Perfect for Families & Retirees</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Holden Beach is a quiet, peaceful residential beach community perfect for families and retirees seeking a slower pace of life. Known for its pristine beaches, friendly atmosphere, and small-town charm, Holden Beach offers an ideal escape with beautiful natural surroundings and welcoming community.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-sky-50 p-6 rounded-lg">
            <div>
              <div className="text-2xl font-bold text-sky-600">~750</div>
              <div className="text-gray-700 text-sm">Population</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-cyan-600">Peaceful</div>
              <div className="text-gray-700 text-sm">Residential Community</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Pristine</div>
              <div className="text-gray-700 text-sm">Atlantic Beaches</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-cyan-600 to-sky-400 text-white">
