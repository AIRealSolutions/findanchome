...
export default function NavasaPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-amber-600 to-yellow-400 text-white py-16">
        <div className="container mx-auto px-4">
          <Link href="/explore/brunswick" className="text-amber-100 hover:text-white mb-4 inline-flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to Brunswick County
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🌾 {CITY_NAME}</h1>
          <p className="text-xl opacity-90">Small Rural Community with Agricultural Heritage & Natural Beauty</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Navasa is a small, charming rural community in Brunswick County with deep agricultural roots and strong community spirit. Known for its peaceful countryside setting and connection to the land, Navasa offers an authentic small-town experience for those seeking a quiet lifestyle away from urban centers.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-yellow-50 p-6 rounded-lg">
            <div>
              <div className="text-2xl font-bold text-amber-600">~300</div>
              <div className="text-gray-700 text-sm">Population</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-yellow-600">Rural</div>
              <div className="text-gray-700 text-sm">Agricultural Community</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Historic</div>
              <div className="text-gray-700 text-sm">Small-Town Charm</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-amber-600 to-yellow-400 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Find Your Home in {CITY_NAME}?</h2>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/search" className="bg-white text-amber-600 px-8 py-3 rounded-lg hover:opacity-90 font-bold">
