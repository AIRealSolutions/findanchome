...
export default function BoliviaPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-green-600 to-lime-400 text-white py-16">
        <div className="container mx-auto px-4">
          <Link href="/explore/brunswick" className="text-green-100 hover:text-white mb-4 inline-flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to Brunswick County
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🌿 {CITY_NAME}</h1>
          <p className="text-xl opacity-90">Rural Community with Natural Beauty & Countryside Living</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Bolivia is a charming rural community in Brunswick County offering a peaceful countryside atmosphere with natural beauty. Perfect for those seeking a quieter lifestyle away from busy urban centers, Bolivia provides a genuine small-town experience with friendly neighbors and outdoor recreation.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-lime-50 p-6 rounded-lg">
            <div>
              <div className="text-2xl font-bold text-green-600">~500</div>
              <div className="text-gray-700 text-sm">Population</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-lime-600">Rural</div>
              <div className="text-gray-700 text-sm">Countryside Setting</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Peaceful</div>
              <div className="text-gray-700 text-sm">Small-Town Living</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-lime-400 text-white">
