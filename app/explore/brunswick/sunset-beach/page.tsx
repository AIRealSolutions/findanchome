...
export default function SunsetBeachPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-orange-600 to-amber-400 text-white py-16">
        <div className="container mx-auto px-4">
          <Link href="/explore/brunswick" className="text-orange-100 hover:text-white mb-4 inline-flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to Brunswick County
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🌅 {CITY_NAME}</h1>
          <p className="text-xl opacity-90">Small Exclusive Community with Bridge Access & Residential Charm</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Sunset Beach is a small, exclusive residential community accessible by a scenic swing bridge. Known for its peaceful atmosphere, pristine beaches, and community charm, Sunset Beach is perfect for those seeking an intimate, quiet escape with a strong sense of place and natural beauty.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-amber-50 p-6 rounded-lg">
            ...
            <div>
              <div className="text-2xl font-bold text-amber-600">Historic</div>
              <div className="text-gray-700 text-sm">Swing Bridge</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Exclusive</div>
              <div className="text-gray-700 text-sm">Private Community</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-amber-400 text-white">
