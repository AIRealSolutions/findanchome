...
const CITY_NAME = 'Boiling Spring Lakes';
...
export default function BoilingSpringLakesPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-cyan-400 text-white py-16">
        <div className="container mx-auto px-4">
          <Link href="/explore/brunswick" className="text-blue-100 hover:text-white mb-4 inline-flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to Brunswick County
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">💧 {CITY_NAME}</h1>
          <p className="text-xl opacity-90">Lake Community with Waterfront Homes & Outdoor Recreation</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Boiling Spring Lakes is a beautiful lake community known for its natural springs, pristine lakes, and waterfront living. With a strong community focus on environmental conservation and outdoor recreation, it's perfect for nature lovers and families seeking a balanced lifestyle.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-cyan-50 p-6 rounded-lg">
            <div>
            ...
            <div>
              ...
              <div className="text-gray-700 text-sm">Fresh-Water Lakes</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Nature</div>
              <div className="text-gray-700 text-sm">Preservation Focus</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-cyan-400 text-white">
