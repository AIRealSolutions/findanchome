    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-cyan-400 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl opacity-90">Historic Port Town with Charming Downtown & Cultural Appeal</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Southport is a charming historic port town renowned for its picturesque riverfront, vibrant downtown district, and rich cultural heritage. Known as the "Wilmington of the North," Southport attracts visitors and residents with its unique blend of maritime history, fine dining, shopping, and waterfront activities.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-blue-50 p-6 rounded-lg">
            ...
            <div>
              <div className="text-2xl font-bold text-cyan-600">Cape Fear River</div>
              <div className="text-gray-700 text-sm">Waterfront Location</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Film Capital</div>
              <div className="text-gray-700 text-sm">Of North Carolina</div>
            </div>
          </div>
        </div>
      </section>
