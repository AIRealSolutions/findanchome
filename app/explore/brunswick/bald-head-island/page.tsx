...
const CITY_NAME = 'Bald Head Island';
...
export default function BaldHeadIslandPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-rose-600 to-pink-400 text-white py-16">
        <div className="container mx-auto px-4">
          <Link href="/explore/brunswick" className="text-rose-100 hover:text-white mb-4 inline-flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to Brunswick County
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🏝️ {CITY_NAME}</h1>
          <p className="text-xl opacity-90">Exclusive Maritime Island Destination with Historic Light Tower</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Bald Head Island is an exclusive, pristine maritime destination accessible only by ferry. Known for its historic Cape Fear Lighthouse, pristine beaches, and natural beauty, this exclusive island offers a unique retreat for those seeking privacy and natural splendor.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-pink-50 p-6 rounded-lg">
            <div>
              <div className="text-2xl font-bold text-rose-600">~150</div>
              <div className="text-gray-700 text-sm">Residents</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-pink-600">Ferry Access</div>
              <div className="text-gray-700 text-sm">Only Island Community</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Historic</div>
              <div className="text-gray-700 text-sm">Cape Fear Lighthouse</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-rose-600 to-pink-400 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Find Your Home on {CITY_NAME}?</h2>
