...
const CITY_NAME = 'Ocean Isle Beach';
...
export default function OceanIsleBeachPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-violet-400 text-white py-16">
        <div className="container mx-auto px-4">
          <Link href="/explore/brunswick" className="text-indigo-100 hover:text-white mb-4 inline-flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to Brunswick County
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">✨ {CITY_NAME}</h1>
          <p className="text-xl opacity-90">Upscale Beach Community with Excellent Golf & Resort Amenities</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Ocean Isle Beach is an upscale beach community offering world-class golf courses, luxury resort amenities, and pristine beaches. Perfect for discerning homeowners and golfers, Ocean Isle Beach combines elegance with natural beauty and exceptional recreational opportunities.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 bg-violet-50 p-6 rounded-lg">
            <div>
              <div className="text-2xl font-bold text-indigo-600">~600</div>
              <div className="text-gray-700 text-sm">Population</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-violet-600">Championship</div>
              <div className="text-gray-700 text-sm">Golf Courses</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1e3a8a]">Luxury</div>
              <div className="text-gray-700 text-sm">Resort Living</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-violet-400 text-white">
